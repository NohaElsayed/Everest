            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i>
                        {{\App\CPU\translate('Orders Deliveries')}} {{\App\CPU\translate('list')}}
                        {{-- ( {{ $delivery_men->total() }} ) --}}
                    </h1>
                </div>
            </div>
                        ...
                        <div class="col-12 ">
                            <div class="row flex-between justify-content-between align-items-center">
                                {{-- <div class="mb-1 col-md-4">
                                 ...
                                 --}}
                                <div class="col-md-3 ">
                                    {{-- <a href="{{route('admin-delivery.delivery-man.add')}}" class="btn btn-primary float-right"><i
                    ...
                    <div class="table-responsive datatable-custom">
                        <table
                            ...
                            <tr>
                                ...
                                <th style="width: 30%">{{\App\CPU\translate('Order')}}</th>
                                <th style="width: 25%">{{\App\CPU\translate('Delivery')}}</th>
                            ...
                            <tbody id="set-rows">
                            @foreach($deliveryhistory as $dm)
                                <tr>
                                    <td>{{ $dm ->id }}</td>
                                    <td>{{$dm ->order_id}}
                                    </td>
                                    <td> {{$dm ->deliveryman_id}}</td>
                                    <td>{{$dm ->time}}</td>
                                    <td>{{$dm ->location}}</td>
                                    {{-- <td>
