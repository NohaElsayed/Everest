...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'subscription', 'as' => 'subscription.','middleware' => ['module:zone']], function () {
            ...
            Route::get('delete/{id}', 'SubscriptionController@delete')->name('delete');
...
//            Route::get('export', 'BrandController@export')->name('export');
        ...
        Route::group(['prefix' => 'services', 'as' => 'services.','middleware'=>['module:product_management']], function () {
            Route::get('add-new', 'ServiceController@add_new')->name('add-new');
